                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control form-control-lg"
                                    ...
                                    cols="30">{{ old('description', $product->description) }}</textarea>
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="file" name="image" id="image" class="form-control form-control-lg"
                                    placeholder="Image">
                                @if ($product->image != "")
                                <img src="{{asset('uploads/products/'.$product->image)}}" class="w-50 my-3"
                                    alt="{{asset('uploads/products/'.$product->image)}}">
                                @endif
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" name="totalprice" id="totalprice" class="form-control form-control-lg"
                                    placeholder="Total Price" value="{{ $product->price }}" readonly>
                            </div>
                            <div class="d-grid">
                                <button class="btn btn-dark btn-lg btn-primary">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
